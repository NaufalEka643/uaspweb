            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">IAGROW merupakan website blog penyedia informasi tentang agriculture yang menyediakan berbagai konten terkait dengan agriculture. Dalam website ini, pengguna dapat menemukan artikel-artikel informatif, berita terkini, dan sumber daya informasi lainnya yang berkaitan dengan berbagai aspek agriculture.
                        Website ini dikelola oleh tim pengelola/admin sehingga informasi yang disajikan dapat dipercaya, terkini,
                        </p></div>
                    <div class="col-lg-4 me-auto"><p class="lead"></p>dan relevan untuk pembaca dalam meningkatkan praktik pertanian mereka, menghadapi tantangan yang mungkin muncul atau hanya sekedar menambah wawasan. selain itu, website ini juga menyediakan kolom komentar dibawah artikel, sehingga memungkinkan pembaca untuk berbagi ilmu dan pengalaman dengan pembaca lain. Hal ini memungkinkan untuk pembaca belajar satu sama lain dan memperluas jaringan mereka dalam industri pertanian.</div>
                </div>
